...
//ol.proj.get("EPSG:32721").setExtent([434730.039706, 7203112.554026, 435356.616877, 7203444.083790]);
var wms_layers = [];
...
var format_PostacionL1SistExistente22052025_4 = new ol.format.GeoJSON();
var features_PostacionL1SistExistente22052025_4 = format_PostacionL1SistExistente22052025_4.readFeatures(json_PostacionL1SistExistente22052025_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL1SistExistente22052025_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL1SistExistente22052025_4.addFeatures(features_PostacionL1SistExistente22052025_4);
var lyr_PostacionL1SistExistente22052025_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL1SistExistente22052025_4, 
                style: style_PostacionL1SistExistente22052025_4,
                popuplayertitle: 'Postacion L1 Sist Existente 22-05-2025',
                interactive: true,
                title: '<img src="styles/legend/PostacionL1SistExistente22052025_4.png" /> Postacion L1 Sist Existente 22-05-2025'
            });
var format_PostacionL1SistNueva22052025_5 = new ol.format.GeoJSON();
var features_PostacionL1SistNueva22052025_5 = format_PostacionL1SistNueva22052025_5.readFeatures(json_PostacionL1SistNueva22052025_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL1SistNueva22052025_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL1SistNueva22052025_5.addFeatures(features_PostacionL1SistNueva22052025_5);
var lyr_PostacionL1SistNueva22052025_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL1SistNueva22052025_5, 
                style: style_PostacionL1SistNueva22052025_5,
                popuplayertitle: 'Postacion L1 Sist Nueva 22-05-2025',
                interactive: true,
                title: '<img src="styles/legend/PostacionL1SistNueva22052025_5.png" /> Postacion L1 Sist Nueva 22-05-2025'
            });
...
var format_PDSist02062025_12 = new ol.format.GeoJSON();
var features_PDSist02062025_12 = format_PDSist02062025_12.readFeatures(json_PDSist02062025_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDSist02062025_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDSist02062025_12.addFeatures(features_PDSist02062025_12);
var lyr_PDSist02062025_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDSist02062025_12, 
                style: style_PDSist02062025_12,
                popuplayertitle: 'PD Sist 02-06-2025',
                interactive: true,
                title: '<img src="styles/legend/PDSist02062025_12.png" /> PD Sist 02-06-2025'
            });
...
var group_Lote9 = new ol.layer.Group({
                                ...
                                title: 'Lote 9'});
var group_LOTE1 = new ol.layer.Group({
                                layers: [lyr_PostacinExistenteL1PLANO_2,lyr_PostacionL1Fichas19122024_3,lyr_PostacionL1SistExistente22052025_4,lyr_PostacionL1SistNueva22052025_5,],
                                fold: 'close',
                                title: 'LOTE 1'});
var group_LOTE2 = new ol.layer.Group({
                                layers: [],
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_PostacinExistenteL1PLANO_2.setVisible(true);lyr_PostacionL1Fichas19122024_3.setVisible(true);lyr_PostacionL1SistExistente22052025_4.setVisible(true);lyr_PostacionL1SistNueva22052025_5.setVisible(true);lyr_APL1_6.setVisible(true);lyr_APL104032025_7.setVisible(true);lyr_BT3x701x501x25L1_8.setVisible(true);lyr_MT3x35L1_9.setVisible(true);lyr_MT3x70L1_10.setVisible(true);lyr_MT3x185L1_11.setVisible(true);lyr_PDSist02062025_12.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_OpenStreetMap_1,group_LOTE1,group_Lote1,lyr_BT3x701x501x25L1_8,lyr_MT3x35L1_9,lyr_MT3x70L1_10,lyr_MT3x185L1_11,lyr_PDSist02062025_12];
...
lyr_PostacionL1SistExistente22052025_4.set('fieldAliases', {'Alimentadores Lote 1': 'Alimentadores Lote 1', 'Numero de Sosten': 'Numero de Sosten', 'Tipo de Poste': 'Tipo de Poste', 'N�mero de F�brica del Poste': 'N�mero de F�brica del Poste', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
lyr_PostacionL1SistNueva22052025_5.set('fieldAliases', {'Alimentadores Lote 1': 'Alimentadores Lote 1', 'Numero de Sosten': 'Numero de Sosten', 'Tipo de Poste': 'Tipo de Poste', 'N�mero de F�brica del Poste': 'N�mero de F�brica del Poste', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PDSist02062025_12.set('fieldAliases', {'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 1': 'Alimentadores Lote 1', 'Nro de Fabrica del trafo': 'Nro de Fabrica del trafo', 'N�ANDE': 'N�ANDE', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PostacionL1SistExistente22052025_4.set('fieldImages', {'Alimentadores Lote 1': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'N�mero de F�brica del Poste': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
lyr_PostacionL1SistNueva22052025_5.set('fieldImages', {'Alimentadores Lote 1': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'N�mero de F�brica del Poste': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
...
lyr_PDSist02062025_12.set('fieldImages', {'Numero de Sosten': 'TextEdit', 'Alimentadores Lote 1': 'TextEdit', 'Nro de Fabrica del trafo': 'Range', 'N�ANDE': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
...
lyr_PostacionL1SistExistente22052025_4.set('fieldLabels', {'Alimentadores Lote 1': 'no label', 'Numero de Sosten': 'no label', 'Tipo de Poste': 'no label', 'N�mero de F�brica del Poste': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_PostacionL1SistNueva22052025_5.set('fieldLabels', {'Alimentadores Lote 1': 'no label', 'Numero de Sosten': 'no label', 'Tipo de Poste': 'no label', 'N�mero de F�brica del Poste': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
...
lyr_PDSist02062025_12.set('fieldLabels', {'Numero de Sosten': 'no label', 'Alimentadores Lote 1': 'no label', 'Nro de Fabrica del trafo': 'no label', 'N�ANDE': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_PDSist02062025_12.on('precompose', function(evt) {
