...
//ol.proj.get("EPSG:32721").setExtent([431765.040801, 7197223.875301, 449338.980128, 7206474.448471]);
var wms_layers = [];
...
var format_PDL1Sist02072025_14 = new ol.format.GeoJSON();
var features_PDL1Sist02072025_14 = format_PDL1Sist02072025_14.readFeatures(json_PDL1Sist02072025_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDL1Sist02072025_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDL1Sist02072025_14.addFeatures(features_PDL1Sist02072025_14);
var lyr_PDL1Sist02072025_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDL1Sist02072025_14, 
                style: style_PDL1Sist02072025_14,
                popuplayertitle: 'PD L1 Sist 02-07-2025',
                interactive: true,
                title: '<img src="styles/legend/PDL1Sist02072025_14.png" /> PD L1 Sist 02-07-2025'
            });
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_PostacinExistenteL1PLANO_2.setVisible(true);lyr_PostacionL1Fichas19122024_3.setVisible(true);lyr_PostacionL1SistExist02072025_4.setVisible(true);lyr_PostacionL1SistNuevo02072025_5.setVisible(true);lyr_APL1_6.setVisible(true);lyr_APL104032025_7.setVisible(true);lyr_RETIRO_8.setVisible(true);lyr_BT3x701x501x25L1_9.setVisible(true);lyr_MT3x35L1_10.setVisible(true);lyr_MT3x70L1_11.setVisible(true);lyr_MT3x185L1_12.setVisible(true);lyr_PDL1_13.setVisible(true);lyr_PDL1Sist02072025_14.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_OpenStreetMap_1,group_LOTE1,group_Lote1,lyr_RETIRO_8,lyr_BT3x701x501x25L1_9,lyr_MT3x35L1_10,lyr_MT3x70L1_11,lyr_MT3x185L1_12,lyr_PDL1_13,lyr_PDL1Sist02072025_14];
...
lyr_PDL1Sist02072025_14.set('fieldAliases', {'Tipo de Poste': 'Tipo de Poste', 'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 1': 'Alimentadores Lote 1', 'Nro de Fabrica del trafo': 'Nro de Fabrica del trafo', 'N�ANDE': 'N�ANDE', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PDL1Sist02072025_14.set('fieldImages', {'Tipo de Poste': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Alimentadores Lote 1': 'TextEdit', 'Nro de Fabrica del trafo': 'Range', 'N�ANDE': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
...
lyr_PDL1Sist02072025_14.set('fieldLabels', {'Tipo de Poste': 'no label', 'Numero de Sosten': 'no label', 'Alimentadores Lote 1': 'no label', 'Nro de Fabrica del trafo': 'no label', 'N�ANDE': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_PDL1Sist02072025_14.on('precompose', function(evt) {
