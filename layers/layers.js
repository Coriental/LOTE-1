...
//ol.proj.get("EPSG:32721").setExtent([428356.359109, 7196992.891228, 451007.775690, 7208822.497557]);
var wms_layers = [];
...
var format_PDL1_3 = new ol.format.GeoJSON();
var features_PDL1_3 = format_PDL1_3.readFeatures(json_PDL1_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDL1_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDL1_3.addFeatures(features_PDL1_3);
var lyr_PDL1_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDL1_3, 
                style: style_PDL1_3,
                popuplayertitle: "PD L1.",
                interactive: true,
                title: '<img src="styles/legend/PDL1_3.png" /> PD L1.'
            });
var format_Lote116122024_4 = new ol.format.GeoJSON();
var features_Lote116122024_4 = format_Lote116122024_4.readFeatures(json_Lote116122024_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_Lote116122024_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lote116122024_4.addFeatures(features_Lote116122024_4);
var lyr_Lote116122024_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lote116122024_4, 
                style: style_Lote116122024_4,
                popuplayertitle: "Lote 1 16-12-2024",
                interactive: true,
                title: '<img src="styles/legend/Lote116122024_4.png" /> Lote 1 16-12-2024'
            });
var format_PostacinExistenteL1PLANO_5 = new ol.format.GeoJSON();
var features_PostacinExistenteL1PLANO_5 = format_PostacinExistenteL1PLANO_5.readFeatures(json_PostacinExistenteL1PLANO_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacinExistenteL1PLANO_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacinExistenteL1PLANO_5.addFeatures(features_PostacinExistenteL1PLANO_5);
var lyr_PostacinExistenteL1PLANO_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacinExistenteL1PLANO_5, 
                style: style_PostacinExistenteL1PLANO_5,
                popuplayertitle: "Postación Existente L1 PLANO",
                interactive: true,
                title: '<img src="styles/legend/PostacinExistenteL1PLANO_5.png" /> Postación Existente L1 PLANO'
            });
var format_PostacionL1Fichas19122024_6 = new ol.format.GeoJSON();
var features_PostacionL1Fichas19122024_6 = format_PostacionL1Fichas19122024_6.readFeatures(json_PostacionL1Fichas19122024_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL1Fichas19122024_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL1Fichas19122024_6.addFeatures(features_PostacionL1Fichas19122024_6);
var lyr_PostacionL1Fichas19122024_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL1Fichas19122024_6, 
                style: style_PostacionL1Fichas19122024_6,
                popuplayertitle: "Postacion L1 Fichas 19-12-2024",
                interactive: true,
                title: '<img src="styles/legend/PostacionL1Fichas19122024_6.png" /> Postacion L1 Fichas 19-12-2024'
            });
var format_PostacionL1SistNuevo28122024_7 = new ol.format.GeoJSON();
var features_PostacionL1SistNuevo28122024_7 = format_PostacionL1SistNuevo28122024_7.readFeatures(json_PostacionL1SistNuevo28122024_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL1SistNuevo28122024_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL1SistNuevo28122024_7.addFeatures(features_PostacionL1SistNuevo28122024_7);
var lyr_PostacionL1SistNuevo28122024_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL1SistNuevo28122024_7, 
                style: style_PostacionL1SistNuevo28122024_7,
                popuplayertitle: "Postacion L1 Sist Nuevo 28-12-2024",
                interactive: true,
                title: '<img src="styles/legend/PostacionL1SistNuevo28122024_7.png" /> Postacion L1 Sist Nuevo 28-12-2024'
            });
var format_PostacionL1SistExistente28122024_8 = new ol.format.GeoJSON();
var features_PostacionL1SistExistente28122024_8 = format_PostacionL1SistExistente28122024_8.readFeatures(json_PostacionL1SistExistente28122024_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL1SistExistente28122024_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL1SistExistente28122024_8.addFeatures(features_PostacionL1SistExistente28122024_8);
var lyr_PostacionL1SistExistente28122024_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL1SistExistente28122024_8, 
                style: style_PostacionL1SistExistente28122024_8,
                popuplayertitle: "Postacion L1 Sist Existente 28-12-2024",
                interactive: true,
                title: '<img src="styles/legend/PostacionL1SistExistente28122024_8.png" /> Postacion L1 Sist Existente 28-12-2024'
            });
...
var group_Lote6 = new ol.layer.Group({
                                ...
                                title: "Lote 6"});
var group_LOTE1 = new ol.layer.Group({
                                layers: [lyr_PostacinExistenteL1PLANO_5,lyr_PostacionL1Fichas19122024_6,lyr_PostacionL1SistNuevo28122024_7,lyr_PostacionL1SistExistente28122024_8,],
                                fold: "open",
                                title: "LOTE 1"});
var group_LOTE2 = new ol.layer.Group({
                                layers: [],
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_APL1_2.setVisible(true);lyr_PDL1_3.setVisible(true);lyr_Lote116122024_4.setVisible(true);lyr_PostacinExistenteL1PLANO_5.setVisible(true);lyr_PostacionL1Fichas19122024_6.setVisible(true);lyr_PostacionL1SistNuevo28122024_7.setVisible(true);lyr_PostacionL1SistExistente28122024_8.setVisible(true);lyr_BT3x701x501x25L1_9.setVisible(true);lyr_MT3x35L1_10.setVisible(true);lyr_MT3x70L1_11.setVisible(true);lyr_MT3x185L1_12.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_OpenStreetMap_1,group_Lote1,lyr_PDL1_3,lyr_Lote116122024_4,group_LOTE1,lyr_BT3x701x501x25L1_9,lyr_MT3x35L1_10,lyr_MT3x70L1_11,lyr_MT3x185L1_12];
...
lyr_PDL1_3.set('fieldAliases', {'Item': 'Item', 'Certificado': 'Certificado', 'ESTADO': 'ESTADO', 'Fecha de montaje': 'Fecha de montaje', 'Alimentador': 'Alimentador', 'Contratista': 'Contratista', 'Nro de Sosten': 'Nro de Sosten', 'CANTIDAD': 'CANTIDAD', 'Sigla PD': 'Sigla PD', 'Numero': 'Numero', 'Nro de OT': 'Nro de OT', 'Dirección': 'Dirección', 'Ciudad': 'Ciudad', 'Coordenada X': 'Coordenada X', 'Coordenada Y': 'Coordenada Y', 'N° Ande': 'N° Ande', 'N° Fabrica': 'N° Fabrica', 'Marca': 'Marca', 'Potencia': 'Potencia', 'Descargador': 'Descargador', 'Corriente Nominal': 'Corriente Nominal', 'Seccionador MT': 'Seccionador MT', 'Fusible Cartucho MT': 'Fusible Cartucho MT', 'Seccionador BT': 'Seccionador BT', 'Fusible NH': 'Fusible NH', 'SPAT (Ohm)': 'SPAT (Ohm)', 'Fecha en servicio': 'Fecha en servicio', 'Hora': 'Hora', });
lyr_Lote116122024_4.set('fieldAliases', {'Alimentadores Lote 1': 'Alimentadores Lote 1', 'Numero de Sosten': 'Numero de Sosten', 'DENOMINACI�N': 'DENOMINACI�N', 'Latitud': 'Latitud', 'Longitud': 'Longitud', });
lyr_PostacinExistenteL1PLANO_5.set('fieldAliases', {'Nro. De So': 'Nro. De So', 'TIPO POSTE': 'TIPO POSTE', 'Coord X': 'Coord X', 'Coord Y': 'Coord Y', 'ESTRUCTURA': 'ESTRUCTURA', 'NRO DE SOS': 'NRO DE SOS', });
lyr_PostacionL1Fichas19122024_6.set('fieldAliases', {'Alimentent': 'Alimentent', 'Nro. De So': 'Nro. De So', 'Tipo/poste': 'Tipo/poste', 'Fabrica': 'Fabrica', 'Coorde. X': 'Coorde. X', 'coorde. Y': 'coorde. Y', });
lyr_PostacionL1SistNuevo28122024_7.set('fieldAliases', {'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 1': 'Alimentadores Lote 1', 'Poste': 'Poste', 'Tipo de Poste': 'Tipo de Poste', 'Latitud': 'Latitud', 'Longitud': 'Longitud', 'Autor': 'Autor', });
lyr_PostacionL1SistExistente28122024_8.set('fieldAliases', {'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 1': 'Alimentadores Lote 1', 'Poste': 'Poste', 'Tipo de Poste': 'Tipo de Poste', 'Latitud': 'Latitud', 'Longitud': 'Longitud', 'Autor': 'Autor', });
...
lyr_PDL1_3.set('fieldImages', {'Item': 'TextEdit', 'Certificado': 'Range', 'ESTADO': 'TextEdit', 'Fecha de montaje': 'TextEdit', 'Alimentador': 'TextEdit', 'Contratista': 'TextEdit', 'Nro de Sosten': 'TextEdit', 'CANTIDAD': 'CheckBox', 'Sigla PD': 'TextEdit', 'Numero': 'Range', 'Nro de OT': 'TextEdit', 'Dirección': 'TextEdit', 'Ciudad': 'TextEdit', 'Coordenada X': 'Range', 'Coordenada Y': 'Range', 'N° Ande': 'Range', 'N° Fabrica': 'Range', 'Marca': 'TextEdit', 'Potencia': 'Range', 'Descargador': 'TextEdit', 'Corriente Nominal': 'TextEdit', 'Seccionador MT': 'TextEdit', 'Fusible Cartucho MT': 'TextEdit', 'Seccionador BT': 'TextEdit', 'Fusible NH': 'TextEdit', 'SPAT (Ohm)': 'TextEdit', 'Fecha en servicio': 'TextEdit', 'Hora': 'DateTime', });
lyr_Lote116122024_4.set('fieldImages', {'Alimentadores Lote 1': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'DENOMINACI�N': 'TextEdit', 'Latitud': 'TextEdit', 'Longitud': 'TextEdit', });
lyr_PostacinExistenteL1PLANO_5.set('fieldImages', {'Nro. De So': 'TextEdit', 'TIPO POSTE': 'TextEdit', 'Coord X': 'TextEdit', 'Coord Y': 'TextEdit', 'ESTRUCTURA': 'TextEdit', 'NRO DE SOS': 'TextEdit', });
lyr_PostacionL1Fichas19122024_6.set('fieldImages', {'Alimentent': 'TextEdit', 'Nro. De So': 'TextEdit', 'Tipo/poste': 'TextEdit', 'Fabrica': 'Range', 'Coorde. X': 'Range', 'coorde. Y': 'Range', });
lyr_PostacionL1SistNuevo28122024_7.set('fieldImages', {'Numero de Sosten': 'TextEdit', 'Alimentadores Lote 1': 'TextEdit', 'Poste': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'Latitud': 'TextEdit', 'Longitud': 'TextEdit', 'Autor': 'TextEdit', });
lyr_PostacionL1SistExistente28122024_8.set('fieldImages', {'Numero de Sosten': 'TextEdit', 'Alimentadores Lote 1': 'TextEdit', 'Poste': 'TextEdit', 'Tipo de Poste': 'TextEdit', 'Latitud': 'TextEdit', 'Longitud': 'TextEdit', 'Autor': 'TextEdit', });
...
lyr_PDL1_3.set('fieldLabels', {'Item': 'no label', 'Certificado': 'no label', 'ESTADO': 'no label', 'Fecha de montaje': 'no label', 'Alimentador': 'no label', 'Contratista': 'no label', 'Nro de Sosten': 'no label', 'CANTIDAD': 'no label', 'Sigla PD': 'no label', 'Numero': 'no label', 'Nro de OT': 'no label', 'Dirección': 'no label', 'Ciudad': 'no label', 'Coordenada X': 'no label', 'Coordenada Y': 'no label', 'N° Ande': 'no label', 'N° Fabrica': 'no label', 'Marca': 'no label', 'Potencia': 'no label', 'Descargador': 'no label', 'Corriente Nominal': 'no label', 'Seccionador MT': 'no label', 'Fusible Cartucho MT': 'no label', 'Seccionador BT': 'no label', 'Fusible NH': 'no label', 'SPAT (Ohm)': 'no label', 'Fecha en servicio': 'no label', 'Hora': 'no label', });
lyr_Lote116122024_4.set('fieldLabels', {'Alimentadores Lote 1': 'no label', 'Numero de Sosten': 'no label', 'DENOMINACI�N': 'no label', 'Latitud': 'no label', 'Longitud': 'no label', });
lyr_PostacinExistenteL1PLANO_5.set('fieldLabels', {'Nro. De So': 'inline label - always visible', 'TIPO POSTE': 'inline label - always visible', 'Coord X': 'inline label - always visible', 'Coord Y': 'inline label - always visible', 'ESTRUCTURA': 'inline label - always visible', 'NRO DE SOS': 'no label', });
lyr_PostacionL1Fichas19122024_6.set('fieldLabels', {'Alimentent': 'no label', 'Nro. De So': 'no label', 'Tipo/poste': 'no label', 'Fabrica': 'no label', 'Coorde. X': 'no label', 'coorde. Y': 'no label', });
lyr_PostacionL1SistNuevo28122024_7.set('fieldLabels', {'Numero de Sosten': 'no label', 'Alimentadores Lote 1': 'no label', 'Poste': 'no label', 'Tipo de Poste': 'no label', 'Latitud': 'no label', 'Longitud': 'no label', 'Autor': 'no label', });
lyr_PostacionL1SistExistente28122024_8.set('fieldLabels', {'Numero de Sosten': 'no label', 'Alimentadores Lote 1': 'no label', 'Poste': 'no label', 'Tipo de Poste': 'no label', 'Latitud': 'no label', 'Longitud': 'no label', 'Autor': 'no label', });
